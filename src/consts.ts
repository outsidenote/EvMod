export const ELEMENT_METADATA_KEY: string = 'EvModelElementMetadata';
...
export const APP_STORE: string = 'EvModelAppStore'
export const ELEMENT_PAYLOAD_KEY: string  = 'EvModelElementPayload';